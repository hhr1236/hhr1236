...
ship_initial_positions = {
    "铭洋12": {"platform": (13448133.22, 4859466.068)},  # CEP坐标
    "海洋石油231": {"platform": (13448000.87, 4859490.675)},  # H坐标
    "安泉州77": {"platform": (13452403.86, 4860510.515)},  # O坐标
    "德沣": {"platform": (13447245.44, 4857292.809)},  # B坐标
    "威尔7": {"platform": (13479631.19, 4866600.75)},  # JXB坐标
    "东远503": {"platform": (13449133.298273638, 4865627.817903508)},  # SZ36-10/N坐标
}
...
platform_coordinates = {
    ...
    'R': (13455681.61, 4891284.077), "SZ36-10/N": (13449133.298273638, 4865627.817903508),"JXA":(13476188.63,4862683.308)
}
